...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        var menu = new Forms.ContextMenuStrip(); menu.Items.Add("显示 / 隐藏", null, (_, _) => Toggle()); menu.Items.Add("退出", null, (_, _) => { quit = true; tray.Visible = false; System.Windows.Application.Current.Shutdown(); }); tray.ContextMenuStrip = menu;
    ...
    private void OnCollapse(object s, RoutedEventArgs e) { collapsed = !collapsed; Width = collapsed ? 56 : 340; Height = collapsed ? 56 : 480; }
